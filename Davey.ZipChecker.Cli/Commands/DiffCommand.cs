...
public sealed class DiffCommand : Command<DiffSettings>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        for (int i = 0; i < zipPaths.Count; i++)
        {
            ...
            IReadOnlyList<ZipEntryInfo> entries = new ZipContentLister().
                ListContents(zipPaths[i], zipOptions, cancellationToken: cancellationToken);
        ...
        IReadOnlyList<ZipEntryInfo> folderEntries = new FolderContentLister(authProvider)
            .ListContents(folderPath, null, consoleScanProgress);
